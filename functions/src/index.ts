...
import { courseEnroll, getAvailableCourses, getCourseInfo, saveCourse, startCourse } from "./callable/courses";
...
export {
    ...
    saveCourse, getAvailableCourses, getCourseInfo, courseEnroll, startCourse,
