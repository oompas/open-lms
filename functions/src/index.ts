...
import { getQuizResponses, updateQuizQuestions, getQuiz, startQuiz, submitQuiz } from "./callable/quizzes";
...
export {
    ...
    updateQuizQuestions, getQuiz, getQuizResponses, startQuiz, submitQuiz,
