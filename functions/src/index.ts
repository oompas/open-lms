...
import { getQuizResponses, updateQuizQuestions, getQuiz, startQuiz, submitQuiz, getQuestionsToMark } from "./callable/quizzes";
...
export {
    ...
    updateQuizQuestions, getQuiz, getQuizResponses, startQuiz, submitQuiz, getQuestionsToMark,
